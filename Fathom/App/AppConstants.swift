...
struct AppConstants {
    static let appName: String = "Fathom"
    ...
    static var feedbackEmail: String = "elaborapp+fathom@gmail.com"

    static var appStoreURL: URL = URL(string: "https://itunes.apple.com/us/app/fathom-universal-link-testing/id1195310358?l=zh&ls=1&mt=8")!
    static var githubURL: URL = URL(string: "https://github.com/ethanhuang13/fathom")!
